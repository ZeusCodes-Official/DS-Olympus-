# Contribution Guidelines [![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/ZeusCodes-Official/DS-Olympus-/issues) 🤝🏽🍀:
...
*1.*  Fork [this](https://github.com/ZeusCodes-Official/DS-Olympus-.git) repository.
...
git clone https://github.com/<your_username>/DS-Olympus-.git
...
git remote add upstream https://github.com/ZeusCodes-Official/DS-Olympus-.git 
...
- Comment on any existing [issue(s)](https://github.com/https://github.com/ZeusCodes-Official/DS-Olympus-/issues) raised by *project maintainers*. Otherwise raise a [new issue](https://github.com/ZeusCodes-Official/DS-Olympus-/issues/new).
...
*9.* Voila :exclamation: You have made a PR to the DS-Olympus :boom: . Sit back patiently and relax while the project maintainers review your PR. Please understand at times the time can vary from a few hours to a few days.
